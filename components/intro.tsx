...
export default function Intro() {
  ...
  return (
    <section
      id='home'
      className='mb-28 w-[50rem] md:max-w-[55rem] w-full text-center sm:mb-0 flex flex-col items-center justify-center scroll-mt-[100rem]'
    >
      <div>
        <motion.div
      ...
      >
        ...
        <div className='flex flex-row  gap-3'>
          ...
          <a
            className='bg-white text-xl p-5 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60'
